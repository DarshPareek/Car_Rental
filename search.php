...
where tblvehicles.VehiclesTitle=:search || tblvehicles.FuelType=:search || tblvehicles.city=:search || tblbrands.BrandName=:search || tblvehicles.ModelYear=:search";
        ...
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li><i class="fa fa-map" aria-hidden="true"></i><?php echo htmlentities($result->City);?></li>
            </ul>
