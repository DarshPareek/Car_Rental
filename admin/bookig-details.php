...
{				?>	
    ...
    <td>
        <?php 
        $startTime = strtotime($result->FromDate); // Convert FromDate to timestamp
        $endTime = strtotime($result->ToDate); // Convert ToDate to timestamp
        $totalHours = ($endTime - $startTime) / 3600; // Calculate total hours
        echo htmlentities($totalHours);
        ?>
    </td>
    <th>Rent Per Hour</th>
    <td><?php echo htmlentities($pphour=$result->PricePerDay ); // Assuming PricePerDay is the daily rate ?></td>
</tr>
<tr>
    <th colspan="3" style="text-align:center">Grand Total</th>
    <td><?php echo htmlentities($totalHours * $pphour); // Calculate grand total ?></td>
</tr>
<tr>
